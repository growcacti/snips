...
class FileManager:
    def __init__(self):
        ...
        self.root.geometry("220x400")
        self.root.resizable(0, 0)
        self.root.config(bg="Light Green")
        self.create_widgets()

    def create_widgets(self):
        # Place your widget creation code here
        # For example:
        Button(self.root, text="Open a file", command=self.open_file).pack()

    def open_file(self):
        # Implementation of file opening
        pass

    # Define other methods for copy_file, delete_file, etc.

    def start(self):
        self.root.mainloop()

# Create an instance of FileManager and start the application
